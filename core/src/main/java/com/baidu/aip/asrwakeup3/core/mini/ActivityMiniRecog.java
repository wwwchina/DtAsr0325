...
//        params.put(SpeechConstant.VAD_ENDPOINT_TIMEOUT, 0); // 长语音
        params.put("vad","touch");//去掉语音断句
//        params.put("vad.endpoint-timeout","1500");

        params.put("disable-punctuation","true");//去掉标点符号
...
//                        Toast.makeText(ActivityMiniRecog.this,"号码格式不正确",Toast.LENGTH_LONG).show();
    ...
    private void setTxtResult(String str){
        ...
        count.setText("共"+countPageSynbol(str)+"个号码");
    }
    private  int countPageSynbol(String str){
        int count=0;
    ...
    private void showDialog(){
        final AlertDialog alertDialog = new AlertDialog.Builder(this, R.style.CustomDialogStyle).create();
        View v = LayoutInflater.from(ActivityMiniRecog.this).inflate(R.layout.prompt_layout, null);

        TextView   cancle_order_sure = v.findViewById(R.id.cancle_order_sure);
        cancle_order_sure.setOnClickListener(new View.OnClickListener() {
            @Override
